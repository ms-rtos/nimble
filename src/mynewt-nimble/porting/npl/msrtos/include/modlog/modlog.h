...
#define MODLOG_DEBUG(ml_mod_, ml_msg_, ...) \
    ms_printk(MS_PK_DEBUG, (ml_msg_), ##__VA_ARGS__)
#else
...
#define MODLOG_INFO(ml_mod_, ml_msg_, ...) \
    ms_printk(MS_PK_INFO, (ml_msg_), ##__VA_ARGS__)
#else
...
#define MODLOG_WARN(ml_mod_, ml_msg_, ...) \
    ms_printk(MS_PK_WARNING, (ml_msg_), ##__VA_ARGS__)
#else
...
#define MODLOG_ERROR(ml_mod_, ml_msg_, ...) \
    ms_printk(MS_PK_ERR, (ml_msg_), ##__VA_ARGS__)
#else
...
#define MODLOG_CRITICAL(ml_mod_, ml_msg_, ...) \
    ms_printk(MS_PK_CRIT, (ml_msg_), ##__VA_ARGS__)
#else
